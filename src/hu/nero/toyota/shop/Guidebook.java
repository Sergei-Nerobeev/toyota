...
public class Guidebook {
    ...
    private final double CAMRY_COST_PRICE = 5000;
    ...
    public String toString() {
        return
                "CAMRY_COST_PRICE=" + CAMRY_COST_PRICE +
                ", SOLARA_COST_PRICE=" + SOLARA_COST_PRICE +
                ", DYNA_COST_PRICE=" + DYNA_COST_PRICE +
                ", HIANCE_COST_PRICE=" + HIANCE_COST_PRICE;
